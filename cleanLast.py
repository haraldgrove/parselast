...
def prepare_last(target,query, gap):
    ...
    '''
    header_l = ['score','name1','start1','alnSize1','strand1','seqSize1',
                'name2','start2','alnSize2','strand2','seqSize2','blocks',
                'EG', 'E']
    filename = 'last{}_T{}_Q{}.txt'.format(gap, target, query)
    df = pd.read_csv(filename,comment='#', header=None, names=header_l, delim_whitespace=True)
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        query = ['7002','7003','7010','7011','7012','7016',\
                 '8001','8002','8003','8005R','8006',\
                 '9006R','9007R','9011R','9012','9018R','9016R','9023R']
        target = 'orsadb'
    elif len(sys.argv) < 3:
        query = ['7002','7003','7010','7011','7012','7016',\
                 '8001','8002','8003','8005R','8006',\
